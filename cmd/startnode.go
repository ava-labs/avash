...
func init() {
	...
	StartnodeCmd.Flags().StringVar(&flags.NetworkTimeoutReduction, "network-timeout-reduction", flags.NetworkTimeoutReduction, "Reduction of the timeout after a successful request, in nanoseconds. Defaults to `12ms`")
