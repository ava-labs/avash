...
func init() {
	...
	StartnodeCmd.Flags().StringVar(&flags.ConsensusShutdownTimeout, "consensus-shutdown-timeout", flags.ConsensusShutdownTimeout, "imeout before killing an unresponsive chain. Defaults to `5s`")
