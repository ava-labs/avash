cmds = {
    ...
    "startnode node6 --db-type=memdb --staking-enabled=true --http-port=9660 --staking-port=9671 --log-level=debug --bootstrap-ips=127.0.0.1:9651 --bootstrap-ids=NodeID-7Xhw2mDxuDS44j42TCB6U5579esbSt3Lg --staking-tls-cert-file=certs/keys6/staker.crt --staking-tls-key-file=certs/keys6/staker.key",
    "startnode node7 --db-type=memdb --staking-enabled=true --http-port=9662 --staking-port=9673 --log-level=debug --bootstrap-ips=127.0.0.1:9651 --bootstrap-ids=NodeID-7Xhw2mDxuDS44j42TCB6U5579esbSt3Lg --staking-tls-cert-file=certs/keys7/staker.crt --staking-tls-key-file=certs/keys7/staker.key",
}
